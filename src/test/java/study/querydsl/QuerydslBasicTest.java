...
//                .where(team.name.eq("teamA"))
    ...
    /**
     * Tuple 은 Repository 계층에서만 쓰는것을 권장
     */
    @Test
    ...
    /**
     * subQuery 를 사용하기 위해서는 ExpressionUtils.as 를 사용해야 한다.
     */
    @Test
    ...
    @Test
    public void dynamicQuery_BooneanBuilder() throws Exception {
        // given
    ...
    @Test
    public void sqlFunction3() throws Exception {
        List<String> result = jpaQueryFactory
                .select(member.username)
                .from(member)
